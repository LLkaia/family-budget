...
Revision ID: 5b19f4d1f473
Revises:
Create Date: 2024-09-07 12:03:14.553640
...
def upgrade() -> None:
    ...
    op.create_table('budgetcategorylink',
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['budget_category_id'], ['budgetcategorylink.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('budgetcategorylink')
